...
function draw() {
  ...
  // Provide your Code below
    ...
    background(0, drawingParams.alpha);
    translate(width / 2, height / 2);
    stroke(0, 15, 30);
    strokeWeight(drawingParams.weight);    
    scale(drawingParams.zoom);
    for (var i = 0; i < 100; i++) {
      fill(i * 10, 255 - i*25, 255 - i * 10, 100);
      scale(0.95);
      rotate(radians(angle));
      rect(0, 0, drawingParams.rectWidth, 800); 
}
angle += drawingParams.speed; 
}
